...
import kr.co.practice.vo.PhotoVo;
...
public class UploadController {
	...
	public void multiplePhotoUpload(HttpServletRequest request, HttpServletResponse response){
	    try {
	         ...
	         String filePath = dftFilePath + "resources" + File.separator + "photo_upload"+ datePath + File.separator;
	         ...
	         sFileInfo += "&sFileURL="+"/myBoard/resources/photo_upload/"+realFileNm;
